...
#         target_models={5}  # 焊机开关视频流,目标检测（开关）
#     )
# ]
...
WELDING_K2_CONFIG= ServerConfig(
    ...
    server_port=5002,
    weights_paths=[
        os.path.join(WEIGHTS_BASE_DIR, 'jidian/welding_oil_tank.pt'),
        os.path.join(WEIGHTS_BASE_DIR, 'yolo11l-seg.pt'),
        os.path.join(WEIGHTS_BASE_DIR, 'jidian/welding_light_view.pt'),
        os.path.join(WEIGHTS_BASE_DIR, 'jidian/welding_desk.pt'),
        os.path.join(WEIGHTS_BASE_DIR, 'jidian/welding_cls.pt'),
        os.path.join(WEIGHTS_BASE_DIR, 'jidian/welding_switch.pt')
    ],
