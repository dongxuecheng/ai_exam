...
from ..schemas import StatusResponse, ExamStatusResponse
import re
...
async def exam_status(service: DetectionManagerDep) -> ExamStatusResponse:
    ...
    try:
        ...
        exam_steps = [
            {"step": re.search(r'basket_exam_(\d+)', value).group(1), "image": service.get_exam_imgs().get(value), "score": service.get_exam_score().get(value)}
